...
public class PullOrderDialogActivity extends ThemedAppCompatActivity {
    ...
    public static final String EXTRA_PULL_ORDER = "${applicationId}.activities.PullOrderDialogActivity.PULL_ORDER";
    public static final String EXTRA_RESULT_PULL_ORDER = "${applicationId}.activities.PullOrderDialogActivity.EXTRA_RESULT_PULL_ORDER";
