...
public class DeviceActivity extends SyncthingActivity implements View.OnClickListener {
    ...
    public static final String EXTRA_NOTIFICATION_ID =
            "${applicationId}.activities.DeviceActivity.NOTIFICATION_ID";
    public static final String EXTRA_DEVICE_ID =
            "${applicationId}.activities.DeviceActivity.DEVICE_ID";
    public static final String EXTRA_DEVICE_NAME =
            "${applicationId}.activities.DeviceActivity.DEVICE_NAME";
    public static final String EXTRA_IS_CREATE =
            "${applicationId}.activities.DeviceActivity.IS_CREATE";
